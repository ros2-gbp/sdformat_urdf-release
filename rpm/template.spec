...
%global pkg_name sdformat_test_files
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-sdformat-test-files
Version:        2.1.1
Release:        1%{?dist}
...
%changelog
* Tue Jul 21 2026 Shane Loretz <sloretz@osrfoundation.org> - 2.1.1-1
- Autogenerated by Bloom

* Mon Jul 20 2026 Shane Loretz <sloretz@osrfoundation.org> - 3.0.0-1
- Autogenerated by Bloom

* Wed Apr 29 2026 Shane Loretz <sloretz@osrfoundation.org> - 2.1.0-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Shane Loretz <sloretz@osrfoundation.org> - 2.1.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Shane Loretz <sloretz@osrfoundation.org> - 2.1.0-1
- Autogenerated by Bloom
